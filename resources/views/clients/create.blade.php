...
<div class="col-md-6 col-md-offset-3 text-center">
    ...
    <form action="{{ route('clients.store') }}" method="post" class="text-center" >
        ...
        <div class="form-group col-md-6" >
            ...
            <input id="addresse" type="text" name="addresse" class="form-control" spellcheck="false"  placeholder="Ngady, Case d'écoute, Salsa" />
        </div>
        <div class="form-group col-md-6" >
        ...
        <div class="form-group col-md-12" >
            ...
            <input id="numero_permis" type="text" name="numero_permis" class="form-control" spellcheck="false"  placeholder="BO212321123" />
        </div>
        <div class="form-group col-md-6" >
            <label for="numero_phone">Numéro de Téléphone<span class="required">*</span></label>
            <input id="numero_phone" type="text" name="numero_phone" class="form-control" spellcheck="false"  placeholder="07158215" />
        </div>
        <div class="form-group col-md-6" >
            <label for="numero_phone2">Deuxieme Numéro de Téléphone<span class="required">*</span></label>
            <input id="numero_phone2" type="text" name="numero_phone2" class="form-control" spellcheck="false"  placeholder="06268275" />
        </div>
        <div class="form-group col-md-6" >
            <label for="email">E-Mail<span class="required">*</span></label>
            <input id="email" type="text" name="email" class="form-control" spellcheck="false" placeholder="servicestousazimuts@gmail.com" />
        </div>
        <div class="form-group col-md-6" >
            <label for="date_naissance">Date de Naissance<span class="required">*</span></label>
            <input id="date_naissance" type="date" name="date_naissance" class="form-control" spellcheck="false"  />
        </div>

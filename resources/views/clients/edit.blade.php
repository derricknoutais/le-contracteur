...
<div class="col-md-6 col-md-offset-3 text-center">
    ...
    <form action="{{ route('clients.update', [$client->id]) }}" method="post" class="text-center" >
                    ...
                    <div class="form-group col-md-6" >
                        ...
                        <input id="addresse" type="text" name="addresse" class="form-control" spellcheck="false" value="{{ $client->addresse }}" />
                    </div>
                    <div class="form-group col-md-6" >
                    ...
                    <div class="form-group col-md-12" >
                        ...
                        <input id="numero_permis" type="text" name="numero_permis" class="form-control" spellcheck="false" value="{{ $client->numero_permis }}" />
                    </div>
                    <div class="form-group col-md-6" >
                        <label for="numero_phone">Numéro de Téléphone<span class="required">*</span></label>
                        <input id="numero_phone" type="text" name="numero_phone" class="form-control" spellcheck="false" value="{{ $client->numero_phone }}" />
                    </div>
                    <div class="form-group col-md-6" >
                        <label for="numero_phone2">Deuxieme Numéro de Téléphone<span class="required">*</span></label>
                        <input id="numero_phone2" type="text" name="numero_phone2" class="form-control" spellcheck="false" value="{{ $client->numero_phone2  }}" />
                    </div>
                    <div class="form-group col-md-6" >
                        <label for="email">E-Mail<span class="required">*</span></label>
                        <input id="email" type="text" name="email" class="form-control" spellcheck="false" value="{{ $client->email }}" />
                    </div>
                    <div class="form-group col-md-6" >
                        <label for="date_naissance">Date de Naissance<span class="required">*</span></label>
                        <input id="date_naissance" type="date" name="date_naissance" class="form-control" spellcheck="false" value="{{ $client->date_naissance }}" />
                    </div>

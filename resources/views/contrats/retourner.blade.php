...
<br>
    ...
    <h5 class="text-center">{{ $contrat->client->nom }} {{ $contrat->client->prenom }} a une caution de la valeur de <span class="text-primary">{{ $contrat->client->caution }}</span>. Combien voulez-vous retourner?</h5>
    <form id="retour-form" action="{{ route('contrats.retourner' , [$contrat->id]) }}" method="POST" class="text-center" >
            ...
            <div class="form-group row">
                <div class="col-md-4 col-md-offset-4">
                    <input type="number" name="caution" class="form-control" step="50000">
                </div>

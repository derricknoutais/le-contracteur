...
<h1 class="text-center">Liste de Contrats</h1>
    ...
    <div class="panel panel-primary ">
        ...
        <div class="panel-body">
            ...
            <tbody>
                    ...
                    <th scope="row"><a class="text-white" href="contrats/{{ $contrat->id }}">00{{ $contrat->id }}</a></th>
                    <td>
                        <a href="clients/{{ $client->id }}" class="text-white" title="">
                            {{ $client->nom }} {{ $client->prenom }}
                        </a>
                    </td>
                    <td>
                        <a href="voitures/{{ $voiture->id }}" title="" class="text-white">

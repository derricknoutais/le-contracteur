    ...
    <form action="{{ route('contrats.store') }}" method="post" class="text-center" >
                    ...
                    @if(Auth::user()->role_id < 2)
                        <div class="form-group col-md-12" >
                            ...
                            <input id="created_at" type="date" name="created_at" class="form-control" spellcheck="false" required value="{{ Carbon::now() }}"/>
                        </div>
                    @endif
                    @if($voitures != null )
                    <div class="form-group col-md-12" >
                    ...
                    <div class="form-group col-md-12" >
                        ...
                        <input id="caution" type="number" name="caution" class="form-control" spellcheck="false" required value="0"/>
                    </div>
                    <div class="form-group col-md-12" >
                        <label for="remise">Remise<span class="required">*</span></label>
                        <input id="remise" type="number" name="remise" class="form-control" spellcheck="false" required value="0" />
                    </div>
                    <div class="form-group" >
                        <input type="submit" class="btn btn-primary" value="Créer Contrat" />
                    </div>
